...
public class SocketServerConfigs {
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            ...
            .define(HTTP_BRIDGE_MAX_REQUEST_BODY_BYTES_CONFIG, INT, HTTP_BRIDGE_MAX_REQUEST_BODY_BYTES_DEFAULT, atLeast(1), LOW, HTTP_BRIDGE_MAX_REQUEST_BODY_BYTES_DOC)
